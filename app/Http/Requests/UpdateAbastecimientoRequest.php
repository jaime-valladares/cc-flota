...
class UpdateAbastecimientoRequest extends FormRequest
{
    /**
     * La autorización multiempresa y la posibilidad real de modificación
     * se validan nuevamente en el controlador y en el servicio.
     */
    ...
    {
        return [
            'abastecimiento_version.required' =>
                'No fue posible confirmar la versión del abastecimiento. Actualice la página antes de continuar.',
            ...
            */
            ...
            'marchamos.*.marchamo_actual_id.required' =>
                'No fue posible identificar el marchamo actual de uno de los tapones.',

            'marchamos.*.marchamo_actual_id.distinct' =>
                'No puede repetir el mismo marchamo actual dentro de la operación.',

            'marchamos.*.marchamo_actual_id.exists' =>
                'Uno de los marchamos actuales ya no existe.',
            ...
            'return_query.max' =>
                'Los parámetros de retorno exceden el tamaño permitido.',
        ];
    }
    ...
    /**
     * Resuelve el modelo de medición desde el abastecimiento de la ruta.
     */
    private function modeloUnidad(): ?string
    {
        ...
        if (
            $abastecimientoRuta
            instanceof Abastecimiento
        ) {
            return $abastecimientoRuta
                ->modelo_medicion;
        }
