...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Estas líneas contienen los mensajes de error utilizados por Laravel
    | cuando una validación falla. Se ajustan al tono formal de CC-Flota.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor ingresado en :attribute apareció en una filtración de datos. Utilice otro valor.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'placa' => 'placa',
        'marca' => 'marca',
        'total_tanques' => 'total de tanques',
        'cantidad_tanques_con_licencia' => 'tanques protegidos',
        'capacidad_total' => 'capacidad total',
        'capacidad_cubierta' => 'capacidad cubierta',
        'modelo_medicion' => 'modelo de medición',
        'motivo_inactivacion' => 'motivo de inactivación',
    ],
