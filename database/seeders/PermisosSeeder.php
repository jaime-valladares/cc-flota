    ...
    public function run(): void
    {
        ...
        foreach ($permisosEmpresasObsoletos as $permisoObsoleto) {
            $permisoObsoleto->update([
                ...
                'motivo_inactivacion' => 'Permiso reemplazado por el mapeo funcional definitivo de los módulos Empresas, Usuarios, Unidades, Licencias, Marchamos, Gasolineras Internas y Gasolineras Externas.',
            ]);
        }
    }
}