...
<head>
    ...
    <title>
        Modificar abastecimiento · CC-Flota
    </title>
    ...
    <style>
        ...
        .cc-abastecimiento-edit-ventana {
            width: 100%;
            min-width: 0;
        }
...
<body class="antialiased">
    <main class="cc-abastecimiento-edit-ventana">
    @php
        ...
        $kilometrajeAnterior = $abastecimientoAnterior
            ? (
                ! is_null(
                    $abastecimientoAnterior
                        ->kilometraje_actual
        ...
        $volumenFinalAnterior = $abastecimientoAnterior
            ? (float) $abastecimientoAnterior
                ->volumen_final
            : null;
            ...
            <div class="cc-card">
                ...
                <section class="cc-detail-section mt-5">
                    <div class="cc-detail-section-header">
                        ...
                        @if ($abastecimiento->esPrimerAbastecimiento())
                            <p>
                                Esta operación corresponde a la línea base de
                                la unidad. La fecha y hora originales no pueden
                                modificarse.
                            </p>
                        @else
                            <p>
                                La modificación recalculará el ciclo cerrado
                                por este abastecimiento sin alterar su fecha y
                                hora originales.
                            </p>
                        @endif
                    </div>
                ...
                >
                    ...
                    <input
                        type="hidden"
                        name="abastecimiento_version"
                        value="{{ $abastecimientoVersion }}"
                    >
                            ...
                            >
                                ...
                                <div class="cc-field">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('kilometraje_actual', $abastecimiento->kilometraje_actual) }}"
                                        class="cc-input"
                                ...
                                @if ($unidad->modelo_medicion === 'galones_hora')
                                    <div class="cc-field">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('horometro_actual', $abastecimiento->horometro_actual) }}"
                                            class="cc-input"
                                ...
                                <div class="cc-field">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('volumen_inicial', $abastecimiento->volumen_inicial) }}"
                                        class="cc-input"
                                        min="0"
                            ...
                            >
                                ...
                                <div class="cc-field">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('galones_externos', $abastecimiento->esOrigenExterno() ? $abastecimiento->volumen_cargado : null) }}"
                                        class="cc-input"
                                        min="0.01"
                                        step="0.01"
                                        placeholder="0.00"
                    ...
                    <section class="cc-detail-section mt-6">
                        <div class="cc-detail-section-header">
                            <h5>
                                Tapones y marchamos de la operación
                            </h5>

                            <p>
                                Estos marchamos son inmutables desde la edición.
                                La operación solo puede guardarse mientras cada
                                tapón conserve el marchamo instalado por este
                                abastecimiento.
                            </p>
                        </div>
                    ...
                    <section class="cc-detail-section mt-6">
                        <div class="cc-detail-section-header">
                            ...
                            <p>
                                Revise los valores calculados antes de guardar.
                                La corrección se aplicará de forma indivisible.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div class="cc-callout-text">
                                    Al guardar se recalculará el abastecimiento
                                    y se aplicarán los ajustes de inventario
                                    necesarios. Los marchamos no se modificarán.
                                    Si una validación falla, no se aplicará
                                    ningún cambio.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cc-form-actions px-5 pb-5">
                            ...
                            <button
                                ...
                                class="cc-btn-primary
                                       cc-btn-form-action"
                                id="boton-modificar-abastecimiento"
                            >
