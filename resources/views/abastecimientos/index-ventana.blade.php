...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Abastecimiento de unidades | CC-Flota</title>
            ...
            <div class="cc-page-wrapper">
                ...
                >
                    <div class="cc-card">
                        ...
                        <form
                            method="GET"
                            action="{{ route('abastecimientos.index.ventana') }}"
                            class="mb-5"
                        >
                            <input
                                type="hidden"
                        ...
                        @if (! $hayFiltros)
                            <section class="cc-empty-panel cc-empty-panel-compact">
                                ...
                                <p>
                                    ...
                                    todas las condiciones necesarias para recibir combustible.
                                </p>
                            </section>
                        @elseif ($unidades->isEmpty())
                            <section class="cc-empty-panel cc-empty-panel-compact">
                                ...
                                <p>
                                    No se encontraron unidades con disponibilidad operativa
                                    total para los filtros seleccionados.
                                </p>
                            </section>
                        @else
