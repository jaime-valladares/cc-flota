...
<style>
    ...
    .cc-route-header > div:last-child {
        display: flex;
    ...
    .cc-route-summary .cc-summary-strip-item {
    ...
    .cc-route-summary .cc-summary-strip-label,
    .cc-route-summary .cc-summary-strip-value {
        width: 100%;
        margin: 0 !important;
        text-align: center !important;
    }
    ...
    .cc-route-chart-canvas {
        display: block;
        width: 100%;
        height: 24rem;
    }

    .cc-route-chart-empty {
        display: flex;
        min-height: 18rem;
        align-items: center;
    ...
    .cc-route-chart-toolbar-actions {
        display: flex;
        flex-wrap: wrap;
        gap: .5rem;
    }

    .cc-route-chart-toolbar-status {
        color: var(--cc-text-muted);
        font-size: .76rem;
        font-weight: 700;
        white-space: nowrap;
    ...
    .cc-route-chart-navigator-label {
        color: var(--cc-text-muted);
        font-size: .72rem;
        font-weight: 700;
        white-space: nowrap;
    ...
    .cc-route-chart-range {
        width: 100%;
        accent-color: var(--cc-primary);
    }

    .cc-route-chart-table-panel[hidden] {
        display: none;
    }

    .cc-route-chart-table-panel {
        margin-top: .85rem;
        overflow-x: auto;
        border: 1px solid var(--cc-border);
        border-radius: .8rem;
    ...
    .cc-route-chart-table th,
    .cc-route-chart-table td {
        padding: .65rem .75rem;
    ...
    .cc-route-chart-table th:first-child,
    .cc-route-chart-table td:first-child,
    .cc-route-chart-table th:nth-child(2),
    .cc-route-chart-table td:nth-child(2) {
        text-align: left;
    }
    ...
    .cc-route-chart-table tbody tr:last-child td {
        border-bottom: 0;
    }

    .cc-route-chart-legend {
        display: flex;
        flex-wrap: wrap;
        gap: 1rem;
        margin-top: .75rem;
    ...
    .cc-route-chart-legend-item {
        display: inline-flex;
        align-items: center;
        gap: .4rem;
    }

    .cc-route-chart-legend-line {
        width: 1.8rem;
        height: .2rem;
        border-radius: 999px;
    }
    ...
    .cc-route-detail-row[hidden] {
        display: none;
    }

    .cc-route-detail-cell {
        padding: 0 !important;
        background: var(--cc-bg-soft);
    }

    .cc-route-detail-panel {
        padding: 1rem;
        border-top: 1px solid var(--cc-border);
        border-bottom: 1px solid var(--cc-border);
    }

    .cc-route-detail-heading {
        display: flex;
    ...
    .cc-route-detail-title {
        color: var(--cc-text-main);
        font-size: .88rem;
        font-weight: 800;
    }

    .cc-route-detail-note {
        max-width: 42rem;
        color: var(--cc-text-muted);
        font-size: .72rem;
        line-height: 1.45;
    ...
    .cc-route-detail-table-wrapper {
        overflow-x: auto;
    }

    .cc-route-detail-table {
        width: 100%;
        min-width: 76rem;
        border-collapse: collapse;
        background: var(--cc-bg-card);
    ...
    .cc-route-detail-table th,
    .cc-route-detail-table td {
        padding: .7rem .75rem;
        border: 1px solid var(--cc-border);
    ...
    @media (max-width: 760px) {
        ...
        .cc-route-header > div:last-child > a {
            width: 100%;
        }
...
<div class="cc-card">
    ...
    @if ($hayFiltros)
        ...
        <div
            class="cc-summary-strip cc-route-summary"
