                    ...
                    <div class="cc-card">
                        ...
                        <div class="cc-card-header cc-card-header-compact">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="{{ route('unidades.administrar.ventana', ['consultar' => 1]) }}" class="cc-btn-secondary cc-btn-wide">
                        ...
                        <div class="cc-actions cc-actions-split">
                            <div class="cc-actions-normal">
                                <a href="{{ route('unidades.edit.ventana', $unidad) }}" class="cc-btn-primary cc-btn-form-action">
                                    Editar unidad
                                </a>

                                <a href="{{ route('unidades.administrar.ventana', ['consultar' => 1]) }}" class="cc-btn-secondary cc-btn-form-action">
                                    Volver a administrar
                                </a>
                            </div>
                        </div>
