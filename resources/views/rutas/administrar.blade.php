            ...
            <div class="cc-card">
                ...
                <div class="cc-card-header cc-card-header-compact">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('rutas.administrar.ventana') }}"
                           target="_blank"
                ...
                <form method="GET" action="{{ route('rutas.administrar') }}" class="mb-5">
                    ...
                    <div class="cc-filter-panel cc-filter-panel-compact cc-filter-panel-inline">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-[1.2fr_1.2fr_auto] gap-4 items-end">
                            ...
                            <div class="flex items-end gap-3">
                                ...
                                <a href="{{ route('rutas.administrar') }}" class="cc-btn-secondary">
                                    Limpiar
                                </a>
                            </div>
                            ...
                            <article class="cc-result-card cc-result-card-compact">
                                <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-5">
                                    ...
                                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 xl:justify-end xl:min-w-[13rem]">
                                        <a href="{{ route('rutas.show', $ruta) }}" class="cc-btn-secondary cc-btn-result">
                                            Ver ficha
                                        </a>

                                        <a href="{{ route('rutas.edit', $ruta) }}" class="cc-btn-primary cc-btn-result">
                                            Editar
                                        </a>
                                    </div>
