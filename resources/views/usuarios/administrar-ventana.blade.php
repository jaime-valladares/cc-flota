            ...
            <div class="cc-page-wrapper">
                <div class="cc-window-container" style="max-width: 80rem;">
                    <div class="cc-card">
                        ...
                        <form method="GET" action="{{ route('usuarios.administrar.ventana') }}" class="mb-5">
                                    ...
                                    <article class="cc-result-card cc-result-card-compact">
                                        <div class="cc-result-grid">
                                            ...
                                            <div class="cc-result-actions">
                                                <a href="{{ route('usuarios.show.ventana', $usuario) }}" class="cc-btn-primary cc-btn-result">
                                                    Ver ficha
                                                </a>

                                                <a href="{{ route('usuarios.edit.ventana', $usuario) }}" class="cc-btn-secondary cc-btn-result">
                                                    Editar
                                                </a>
                                            </div>
