...
<div class="cc-card">
    <div class="cc-card-header cc-card-header-compact">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('usuarios.consulta.ventana', request()->query()) }}"
               target="_blank" rel="noopener noreferrer" class="cc-btn-secondary cc-btn-wide">
    ...
    @php
        $accionFiltro = route('usuarios.index');
        $rutaLimpiar = route('usuarios.index');
    @endphp
