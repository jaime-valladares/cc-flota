...
<div class="cc-card">
    <div class="cc-card-header cc-card-header-compact">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('usuarios.administrar', $queryParams) }}"
    ...
    <div class="cc-actions cc-actions-split">
        <div class="cc-actions-normal">
            @if (
                ...
                <a
                    href="{{ route('usuarios.edit', array_merge($queryParams, ['usuario' => $usuario])) }}"
            ...
            <a
                href="{{ route('usuarios.administrar', $queryParams) }}"
