        ...
        <div class="cc-content-container" style="max-width: 80rem;">
            <div class="cc-card">
                ...
                @php
                    ...
                    $rutaVentana = \Illuminate\Support\Facades\Route::has(
    ...
    <script>
        ...
        function confirmarReemplazos() {
            ...
            const mensaje = cantidad === 1
                ...
                : '¿Está seguro de reemplazar los ' + cantidad + ' marchamos seleccionados? Los marchamos actuales quedarán registrados como históricos.';
