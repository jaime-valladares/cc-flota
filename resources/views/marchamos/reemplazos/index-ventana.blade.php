                    ...
                    <div class="cc-card">
                        ...
                        @if (! $hayFiltros)
                            <section class="cc-empty-panel cc-empty-panel-compact">
                                ...
                                <p>
                                    Use los filtros para localizar unidades
                                    habilitadas para el reemplazo de marchamos.
                                </p>
                            </section>
                        @elseif ($unidadesDisponibles->isEmpty())
                            <section class="cc-empty-panel cc-empty-panel-compact">
                                ...
                                <p>
                                    No se encontraron unidades con empresa
                                    activa, unidad activa, licencia activa y
                                    vigente, y cobertura completa para los
        ...
        <script>
            document
                ...
                .forEach(function (multiselect) {
                    ...
                    const pluralLabel =
                        label?.dataset.pluralLabel || 'seleccionados';
